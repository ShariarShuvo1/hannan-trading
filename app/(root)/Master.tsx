...
export default function Master() {
	return (
		<div className="flex justify-between items-end w-full py-[96px] gap-[64px]">
				...
				<div className="flex flex-col gap-[32px]">
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#EFF8FF] rounded-full text-[#175CD3] items-center border border-[#2E90FA]">
					...
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#FDF2FA] rounded-full text-[#C11574] items-center border border-[#FCCEEE]">
					...
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#FDF2FA] rounded-full text-[#B93815] items-center border border-[#F9DBAF]">
					...
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							<div className="flex flex-col gap-2">
								...
								<div className="font-semibold text-[20px] text-[#181D27] leading-[24px]">
									P.O- Jafar Nagar, P.S- Sitakunda, District
									Chattogram
								</div>
							</div>
							<div className="flex gap-2 h-fit py-[2px] px-[10px] bg-[#EEF4FF] rounded-full text-[#3538CD] items-center border border-[#C7D7FE]">
					...
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#ECFDF3] rounded-full text-[#067647] items-center border border-[#ABEFC6]">
								<div className="min-h-[8px] max-h-[8px] min-w-[8px] max-w-[8px] bg-[#17B26A] rounded-full"></div>
								<div className="text[14px] font-[500]">NID</div>
							</div>
						</div>
					</div>
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#EEF4FF] rounded-full text-[#004EEB] items-center border border-[#C7D7FE]">
								<div className="min-h-[8px] max-h-[8px] min-w-[8px] max-w-[8px] bg-[#6172F3] rounded-full"></div>
								<div className="text[14px] font-[500]">
									Email
								</div>
					...
					<div className="flex flex-col">
						...
						<div className="flex gap-2">
							...
							<div className="flex gap-2 py-[2px] px-[10px] bg-[#FDF4FF] rounded-full text-[#9F1AB1] items-center border border-[#F6D0FE]">
